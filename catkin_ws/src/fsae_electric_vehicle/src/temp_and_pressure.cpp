/*
 * CSUN FSAE EV 2018
 * ROS NODE: temp_and_pressure
 * Topics Subscribed: None 
 * Topics Publishing: temp_and_pressure
 * Tag: 
 * Summary:
 * Related:
 *   Documentation:
 ...
 *   Based on: 
 *     - https://github.com/ControlEverythingCommunity/BMP280.git
*/
...
#include <sstream>
#include "ros/ros.h"
#include "fsae_electric_vehicle/temp_and_pressure.h"
...
int main(int argc, char **argv) 
{
	...
	ros::init (argc, argv, "temp_and_pressure");
	ros::NodeHandle n;

  fsae_electric_vehicle::temp_and_pressure BMP280_data;
  ros::Publisher BMP280_topic = n.advertise<fsae_electric_vehicle::temp_and_pressure>("temp_and_pressure", 1000);
    ...
    BMP280_data.temp = fTemp;
    BMP280_data.pressure = pressure;
    BMP280_topic.publish(BMP280_data);
