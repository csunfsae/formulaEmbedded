...
(cl:defmethod cl:initialize-instance :after ((m <compass>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'compass)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name fsae_electric_vehicle-msg:<compass> is deprecated: use fsae_electric_vehicle-msg:compass instead.")))
...
(cl:defmethod time-val ((m <compass>))
