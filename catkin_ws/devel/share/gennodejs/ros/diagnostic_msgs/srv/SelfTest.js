...
const DiagnosticStatus = require('../msg/DiagnosticStatus.js');
...
class SelfTestRequest {
  ...
  static datatype() {
    // Returns string type for a diagnostic_msgs/SelfTestRequest object
...
class SelfTestResponse {
  ...
  static datatype() {
    // Returns string type for a diagnostic_msgs/SelfTestResponse object
