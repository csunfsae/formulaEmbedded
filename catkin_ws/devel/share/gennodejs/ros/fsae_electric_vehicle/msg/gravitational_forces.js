...
class gravitational_forces {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new gravitational_forces(null);
  ...
  static datatype() {
    ...
    return 'fsae_electric_vehicle/gravitational_forces';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new gravitational_forces(null);
    if (msg.x !== undefined) {
      resolved.x = msg.x;
    }
    else {
...
module.exports = gravitational_forces;
