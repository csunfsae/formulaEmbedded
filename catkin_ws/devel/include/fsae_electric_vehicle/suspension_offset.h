// Generated by gencpp from file fsae_electric_vehicle/suspension_offset.msg
// DO NOT EDIT!


#ifndef FSAE_ELECTRIC_VEHICLE_MESSAGE_SUSPENSION_OFFSET_H
#define FSAE_ELECTRIC_VEHICLE_MESSAGE_SUSPENSION_OFFSET_H
...
struct suspension_offset_
{
  typedef suspension_offset_<ContainerAllocator> Type;
  ...
  typedef boost::shared_ptr< ::fsae_electric_vehicle::suspension_offset_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::fsae_electric_vehicle::suspension_offset_<ContainerAllocator> const> ConstPtr;

}; // struct suspension_offset_

typedef ::fsae_electric_vehicle::suspension_offset_<std::allocator<void> > suspension_offset;

typedef boost::shared_ptr< ::fsae_electric_vehicle::suspension_offset > suspension_offsetPtr;
typedef boost::shared_ptr< ::fsae_electric_vehicle::suspension_offset const> suspension_offsetConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::fsae_electric_vehicle::suspension_offset_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::fsae_electric_vehicle::suspension_offset_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::fsae_electric_vehicle::suspension_offset_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::fsae_electric_vehicle::suspension_offset_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::fsae_electric_vehicle::suspension_offset_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::fsae_electric_vehicle::suspension_offset_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::fsae_electric_vehicle::suspension_offset_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::fsae_electric_vehicle::suspension_offset_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::fsae_electric_vehicle::suspension_offset_<ContainerAllocator> >
{
...
template<class ContainerAllocator>
struct DataType< ::fsae_electric_vehicle::suspension_offset_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::fsae_electric_vehicle::suspension_offset_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::fsae_electric_vehicle::suspension_offset_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::fsae_electric_vehicle::suspension_offset_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::fsae_electric_vehicle::suspension_offset_<ContainerAllocator>& v)
  {
...
#endif // FSAE_ELECTRIC_VEHICLE_MESSAGE_SUSPENSION_OFFSET_H
